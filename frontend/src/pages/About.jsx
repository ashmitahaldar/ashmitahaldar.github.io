    ...
    <div className="min-h-screen pt-20 pb-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {/* Languages */}
          <div className="bg-[#1A1B26] border-2 border-teal-500 rounded-lg p-6 shadow-[0_0_20px_rgba(20,184,166,0.2)]">
            <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              {skills.languages.map(lang => (
                <span key={lang} className="px-3 py-1 bg-[#0A0E27] border border-pink-500/50 rounded text-pink-300 font-mono text-sm hover:border-pink-500 hover:shadow-[0_0_10px_rgba(236,72,153,0.3)] transition-all duration-200">
                  {lang}
                </span>
              ))}
            </div>
          ...
          {/* Frameworks */}
          <div className="bg-[#1A1B26] border-2 border-pink-500 rounded-lg p-6 shadow-[0_0_20px_rgba(236,72,153,0.2)]">
            <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex flex-wrap gap-2">
              {skills.frameworks.map(framework => (
                <span key={framework} className="px-3 py-1 bg-[#0A0E27] border border-teal-500/50 rounded text-teal-300 font-mono text-sm hover:border-teal-500 hover:shadow-[0_0_10px_rgba(20,184,166,0.3)] transition-all duration-200">
                  {framework}
                </span>
              ))}
            </div>
          ...
          <div className="bg-[#1A1B26] border-2 border-pink-500 rounded-lg p-6 shadow-[0_0_20px_rgba(236,72,153,0.2)]">
            ...
            <div className="flex flex-wrap gap-2">
              {skills.tools.map(tool => (
                <span key={tool} className="px-3 py-1 bg-[#0A0E27] border border-pink-500/50 rounded text-pink-300 font-mono text-sm hover:border-pink-500 hover:shadow-[0_0_10px_rgba(236,72,153,0.3)] transition-all duration-200">
                  {tool}
                </span>
              ))}
            </div>
          ...
          <div className="bg-[#1A1B26] border-2 border-teal-500 rounded-lg p-6 shadow-[0_0_20px_rgba(20,184,166,0.2)]">
            ...
            <div className="flex flex-wrap gap-2">
              {skills.interests.map(interest => (
                <span key={interest} className="px-3 py-1 bg-[#0A0E27] border border-teal-500/50 rounded text-teal-300 font-mono text-sm hover:border-teal-500 hover:shadow-[0_0_10px_rgba(20,184,166,0.3)] transition-all duration-200">
                  {interest}
                </span>
              ))}
            </div>
